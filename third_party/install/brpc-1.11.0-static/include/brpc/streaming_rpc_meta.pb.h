...
class StreamSettings final :
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField<::int64_t>& extra_stream_ids() const;
  ::google::protobuf::RepeatedField<::int64_t>* mutable_extra_stream_ids();

  private:
  const ::google::protobuf::RepeatedField<::int64_t>& _internal_extra_stream_ids() const;
  ::google::protobuf::RepeatedField<::int64_t>* _internal_mutable_extra_stream_ids();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedField<::int64_t> extra_stream_ids_;
    ::int64_t stream_id_;
    bool need_feedback_;
    bool writable_;
...
inline int StreamSettings::_internal_extra_stream_ids_size() const {
  return _internal_extra_stream_ids().size();
}
...
inline ::int64_t StreamSettings::extra_stream_ids(int index) const {
  ...
  return _internal_extra_stream_ids().Get(index);
}
inline void StreamSettings::set_extra_stream_ids(int index, ::int64_t value) {
  _internal_mutable_extra_stream_ids()->Set(index, value);
...
inline void StreamSettings::add_extra_stream_ids(::int64_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_extra_stream_ids()->Add(value);
  // @@protoc_insertion_point(field_add:brpc.StreamSettings.extra_stream_ids)
}
inline const ::google::protobuf::RepeatedField<::int64_t>& StreamSettings::extra_stream_ids() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:brpc.StreamSettings.extra_stream_ids)
  return _internal_extra_stream_ids();
}
inline ::google::protobuf::RepeatedField<::int64_t>* StreamSettings::mutable_extra_stream_ids()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:brpc.StreamSettings.extra_stream_ids)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_extra_stream_ids();
}
inline const ::google::protobuf::RepeatedField<::int64_t>& StreamSettings::_internal_extra_stream_ids()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.extra_stream_ids_;
}
inline ::google::protobuf::RepeatedField<::int64_t>* StreamSettings::_internal_mutable_extra_stream_ids() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.extra_stream_ids_;
}
