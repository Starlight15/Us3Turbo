...
echo "===== UCX ====="
run "$UCX/us3_turbo_rtest_ucx_multipart_invalid_part_size"      --part-size 3M
run "$UCX/us3_turbo_rtest_ucx_multipart_part_number_violation"  --part-size 4M
run "$UCX/us3_turbo_rtest_ucx_multipart_single_part"            --part-size 4M
run "$UCX/us3_turbo_rtest_ucx_get_single_block_crc"             --size 2M
run "$UCX/us3_turbo_rtest_ucx_get_multi_block_hash"             --size 8M
