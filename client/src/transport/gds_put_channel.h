...
// gds_put_channel.h — GDS (CUDA cuObj RDMA) 链路 PUT channel。
...
class GdsPutChannel final {
 ...
 private:
  [[nodiscard]] bool ValidateGdsRequest(const ClientProxyPutRequest& req, ConstBufferView buffer) const;
