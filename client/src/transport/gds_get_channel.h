...
class GdsGetChannel final {
 public:
  GdsGetChannel(const ClientOptions& options, const ProxyRpc& proxy, GdsMemoryManager* gds_mgr)
  ...
  [[nodiscard]] bool GetOnce(const std::string& bucket, const std::string& key, MutableBufferView buffer,
