...
//
// client → proxy(CreateMultipartUpload / UploadPartGds / CompleteMultipartUpload)
...
//     --part-size 5M --num-parts 4 [--verify-crc32c]
//
...
int main(int argc, char** argv) {
  ...
  if (!client.CreateMultipartUpload("test-bucket", "gds-multipart.dat",
