...
constexpr int PROXY_ERR_INVALID_PART_SIZE =
    10002;  // part 大小不符合 part_size 约束
...
constexpr int PROXY_ERR_BACKEND_PROTOCOL =
    12004;  // backend protocol decode error
constexpr int PROXY_ERR_BACKEND_FAILED = 12005;
constexpr int PROXY_ERR_PATH_NOT_SUPPORTED =
    13002;  // path 与 RPC 不匹配 / kAll/kNone
constexpr int PROXY_ERR_MISSING_SOURCE = 13003;  // path 指定但对应 source 缺失

/* 错误码通用描述 */
inline const char* ProxyErrorMessage(int code) {
  switch (code) {
    case PROXY_ERR_INVALID_PARAM:
      return "invalid parameter";
    case PROXY_ERR_INVALID_PART_SIZE:
      return "invalid part size";
    case PROXY_ERR_INVALID_PART:
      return "invalid part";
    case PROXY_ERR_INDEX_FAILED:
      return "index write failed";
    case PROXY_ERR_INTERNAL:
      return "internal error";
    case PROXY_ERR_BACKEND_UNAVAILABLE:
      return "backend unavailable";
    case PROXY_ERR_BACKEND_RPC:
      return "backend RPC failed";
    case PROXY_ERR_BACKEND_IO:
      return "backend IO failed";
    case PROXY_ERR_BACKEND_PROTOCOL:
      return "backend protocol error";
    case PROXY_ERR_BACKEND_FAILED:
      return "backend returned error";
    case PROXY_ERR_PATH_NOT_SUPPORTED:
      return "path not supported";
    case PROXY_ERR_MISSING_SOURCE:
