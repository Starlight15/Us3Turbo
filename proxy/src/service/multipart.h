...
class Multipart {
 public:
  ...
  [[nodiscard]] int CreateUpload(const std::string& request_id, const std::string& bucket,
 ...
 private:
  ...
  [[nodiscard]] std::string GenerateBlockKey(const std::string& obj_id,
  ...
  [[nodiscard]] int ValidateUploadPartRdma(const std::string& request_id,
                                           const std::string& upload_id, std::uint32_t part_number,
                                           std::uint64_t part_size, const std::string& rdma_token,
                                           UploadRecord& out_upload);
